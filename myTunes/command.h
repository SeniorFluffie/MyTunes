...
const string CMD_COMPARE = "compare"; // compare shared tracks
const string CMD_REORDER = "reorder"; // reorder tracks
const string CMD_FOLLOW = "follow"; // reorder tracks
...
class Command
{
  public:
   ...
   bool isAppCommand();
   bool isDevCommand();
	 bool isCompareCommand();
	 bool isReorderCommand();
	 bool isFollowCommand();
